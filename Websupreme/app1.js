  ...
  function showData()
{
  ...
  var Score1=firebase.database().ref("Beam Jurnior/ROUND1/Team1/Score");
  var Score2=firebase.database().ref("Beam Jurnior/ROUND1/Team1/Time");

  var Score3=firebase.database().ref("Beam Jurnior/ROUND1/Team2/Score");
  var Score4=firebase.database().ref("Beam Jurnior/ROUND1/Team2/Time");

  var Score5=firebase.database().ref("Beam Jurnior/ROUND1/Team3/Score");
  var Score6=firebase.database().ref("Beam Jurnior/ROUND1/Team3/Time");

  var Score7=firebase.database().ref("Beam Jurnior/ROUND1/Team4/Score");
  var Score8=firebase.database().ref("Beam Jurnior/ROUND1/Team4/Time");

  var Score9=firebase.database().ref("Beam Jurnior/ROUND1/Team5/Score");
  var Score10=firebase.database().ref("Beam Jurnior/ROUND1/Team5/Time");

  var Score11=firebase.database().ref("Beam Jurnior/ROUND1/Team6/Score");
  var Score12=firebase.database().ref("Beam Jurnior/ROUND1/Team6/Time");

  var Score13=firebase.database().ref("Beam Jurnior/ROUND1/Team7/Score");
  var Score14=firebase.database().ref("Beam Jurnior/ROUND1/Team7/Time");

  var Score15=firebase.database().ref("Beam Jurnior/ROUND1/Team8/Score");
  var Score16=firebase.database().ref("Beam Jurnior/ROUND1/Team8/Time");
